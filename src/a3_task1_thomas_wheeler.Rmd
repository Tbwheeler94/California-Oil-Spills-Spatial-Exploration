---
title: "A Spatial Exploration of California Oil Spill Incidents"
author: "Tom Wheeler"
date: "2/17/2021"
output:
  html_document:
...
ca_counties <- read_sf(here("data"), layer = "CA_Counties_TIGER2016") %>%
  clean_names()

#read in California counties layer
oil_spills <- read_sf(here("data"), layer = "Oil_Spill_Incident_Tracking_%5Bds394%5D") %>%
  clean_names()
```
